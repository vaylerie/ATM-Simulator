...
public class SignUpThree extends JFrame implements ActionListener{
    ...
    SignUpThree(String formno){
        ...
        JLabel l1=new JLabel("Halaman 3: Informasi Tambahan");
        l1.setFont(new Font("Raleway",Font.BOLD,22));
        l1.setBounds(280,10,400,40);
        add(l1);
        
         JLabel type=new JLabel("Tipe rekening");
        type.setFont(new Font("Raleway",Font.BOLD,22));
        type.setBounds(100,50,200,30);
        add(type);
        
        r1=new JRadioButton("Rekening Tabungan");
        r1.setFont(new Font("Raleway",Font.BOLD,16));
        r1.setBackground(Color.WHITE);
        r1.setBounds(100,100,250,20);
        add(r1);
        
        r2=new JRadioButton("Deposit Tetap");
        r2.setFont(new Font("Raleway",Font.BOLD,16));
        r2.setBackground(Color.WHITE);
        r2.setBounds(350,100,250,20);
        add(r2);
        
        r3=new JRadioButton("Rekening Saat Ini");
        r3.setFont(new Font("Raleway",Font.BOLD,16));
        r3.setBackground(Color.WHITE);
        r3.setBounds(100,130,250,20);
        add(r3);
        
        r4=new JRadioButton("Rekening Deposit Berkala");
        ...
        JLabel card=new JLabel("Nomor Kartu");
        ...
        JLabel carddetail=new JLabel("Nomor Kartu 16 Angka Anda");
        ...
        JLabel pdetail=new JLabel("PIN 4 Angka");
        ...
        c4=new JCheckBox("Notifikasi Email dan SMS");
        c4.setFont(new Font("Raleway",Font.BOLD,16));
        c4.setBackground(Color.WHITE);
        c4.setBounds(350,380,200,30);
        add(c4);
        
        c5=new JCheckBox("Buku Rekening");
        ...
        c7=new JCheckBox("Saya menyatakan bahwa informasi diatas adalah benar adanya");
        c7.setFont(new Font("Raleway",Font.BOLD,12));
        c7.setBackground(Color.WHITE);
        c7.setBounds(100,450,600,30);
        add(c7);
        
        submit=new JButton("Selesai");
